(function () {
    ...
    angular
         .module('users')
         .controller('User', [
            'userService', 'store', '$firebaseObject', '$timeout', '$mdDialog', '$scope',
            User
         ]);
     ...
     * @constructor
     */
    function User(userService, store, $firebaseObject, $timeout, $mdDialog, $scope) {
        var self = this;
        ...
        $scope.$watch("self.varificationCode.$value", function (newValue, oldValue) {
